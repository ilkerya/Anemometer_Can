...
void UI_Data(){
  //  Serial.println("UI");
    Serial.print(F("Th_1:  "));Serial.println(ThermoCouple.Adr_1);
    Serial.print(F("Th_2:  "));Serial.println(ThermoCouple.Adr_2);
    Serial.print(F("Th_3:  "));Serial.println(ThermoCouple.Adr_3);
    Serial.print(F("Th_4:  "));Serial.println(ThermoCouple.Adr_4);
    Serial.print(F("Th_5:  "));Serial.println(ThermoCouple.Adr_5);
    Serial.print(F("Th_6:  "));Serial.println(ThermoCouple.Adr_6);
    Serial.print(F("Th_7:  "));Serial.println(ThermoCouple.Adr_7);
    Serial.print(F("Th_8:  "));Serial.println(ThermoCouple.Adr_8);   
    Serial.print(F("Th_9:  "));Serial.println(ThermoCouple.Adr_9);
    Serial.print(F("Th_10: "));Serial.println(ThermoCouple.Adr_10);
    Serial.print(F("Th_11: "));Serial.println(ThermoCouple.Adr_11);
    Serial.print(F("Th_12: "));Serial.println(ThermoCouple.Adr_12);

    Serial.print(F("Th_13:  "));Serial.println(ThermoCouple.Adr_13);
    Serial.print(F("Th_14:  "));Serial.println(ThermoCouple.Adr_14);
    Serial.print(F("Th_15:  "));Serial.println(ThermoCouple.Adr_15);
    Serial.print(F("Th_16:  "));Serial.println(ThermoCouple.Adr_16);
    Serial.print(F("Th_17:  "));Serial.println(ThermoCouple.Adr_17);
    Serial.print(F("Th_18:  "));Serial.println(ThermoCouple.Adr_18);
    Serial.print(F("Th_19:  "));Serial.println(ThermoCouple.Adr_19);

    Serial.print(F("Th_20:  "));Serial.println(ThermoCouple.Adr_20);
    Serial.print(F("Th_21:  "));Serial.println(ThermoCouple.Adr_21);
    Serial.print(F("Th_22:  "));Serial.println(ThermoCouple.Adr_22);
    Serial.print(F("Th_23:  "));Serial.println(ThermoCouple.Adr_23);
    Serial.print(F("Th_24:  "));Serial.println(ThermoCouple.Adr_24);
    Serial.print(F("Th_25:  "));Serial.println(ThermoCouple.Adr_25);
    Serial.print(F("Th_26:  "));Serial.println(ThermoCouple.Adr_26);
    Serial.print(F("Th_27:  "));Serial.println(ThermoCouple.Adr_27);
    Serial.print(F("Th_28:  "));Serial.println(ThermoCouple.Adr_28);
    Serial.print(F("Th_29:  "));Serial.println(ThermoCouple.Adr_29);
    
    Serial.print(F("Th_30:  "));Serial.println(ThermoCouple.Adr_30);
    Serial.print(F("Th_31:  "));Serial.println(ThermoCouple.Adr_31); 
    Serial.print(F("Th_32:  "));Serial.println(ThermoCouple.Adr_32);
    Serial.print(F("Th_33:  "));Serial.println(ThermoCouple.Adr_33);
    Serial.print(F("Th_34:  "));Serial.println(ThermoCouple.Adr_34);
    Serial.print(F("Th_35:  "));Serial.println(ThermoCouple.Adr_35);   
    Serial.print(F("Th_36:  "));Serial.println(ThermoCouple.Adr_36);   

    Serial.print(F("Af_1:  "));Serial.println(AirFlow.Adr_1);
    Serial.print(F("Af_2:  "));Serial.println(AirFlow.Adr_2);
    Serial.print(F("Af_3:  "));Serial.println(AirFlow.Adr_3);
    Serial.print(F("Af_4:  "));Serial.println(AirFlow.Adr_4);
    Serial.print(F("Af_5:  "));Serial.println(AirFlow.Adr_5);
    Serial.print(F("Af_6:  "));Serial.println(AirFlow.Adr_6);
    Serial.print(F("Af_7:  "));Serial.println(AirFlow.Adr_7);
    Serial.print(F("Af_8:  "));Serial.println(AirFlow.Adr_8);   
    Serial.print(F("Af_9:  "));Serial.println(AirFlow.Adr_9);
    Serial.print(F("Af_10: "));Serial.println(AirFlow.Adr_10);
    Serial.print(F("Af_11: "));Serial.println(AirFlow.Adr_11);
    Serial.print(F("Af_12: "));Serial.println(AirFlow.Adr_12);
    Serial.print(F("Af_13: "));Serial.println(AirFlow.Adr_13);
    Serial.print(F("Af_14: "));Serial.println(AirFlow.Adr_14);
    Serial.print(F("Af_15: "));Serial.println(AirFlow.Adr_15);
    Serial.print(F("Af_16: "));Serial.println(AirFlow.Adr_16);
    Serial.print(F("Af_17: "));Serial.println(AirFlow.Adr_17);
    Serial.print(F("Af_18: "));Serial.println(AirFlow.Adr_18);
    Serial.print(F("Af_19: "));Serial.println(AirFlow.Adr_19);
    Serial.print(F("Af_20:  "));Serial.println(AirFlow.Adr_20);   
    Serial.print(F("Af_21:  "));Serial.println(AirFlow.Adr_21);
    Serial.print(F("Af_22:  "));Serial.println(AirFlow.Adr_22);     
    Serial.print(F("Af_23:  "));Serial.println(AirFlow.Adr_23);
    Serial.print(F("Af_24:  "));Serial.println(AirFlow.Adr_24);
    Serial.print(F("Af_25:  "));Serial.println(AirFlow.Adr_25);     
    Serial.print(F("Af_26:  "));Serial.println(AirFlow.Adr_26);
    Serial.print(F("Af_27:  "));Serial.println(AirFlow.Adr_27);
    Serial.print(F("Af_28:  "));Serial.println(AirFlow.Adr_28);     
    Serial.print(F("Af_29:  "));Serial.println(AirFlow.Adr_29);    
    Serial.print(F("Af_30:  "));Serial.println(AirFlow.Adr_30);
    Serial.print(F("Af_31:  "));Serial.println(AirFlow.Adr_31);
    Serial.print(F("Af_32:  "));Serial.println(AirFlow.Adr_32);
    Serial.print(F("Af_33:  "));Serial.println(AirFlow.Adr_33);
    Serial.print(F("Af_34:  "));Serial.println(AirFlow.Adr_34);
    Serial.print(F("Af_35:  "));Serial.println(AirFlow.Adr_35);    
    Serial.print(F("Af_36:  "));Serial.println(AirFlow.Adr_36);
